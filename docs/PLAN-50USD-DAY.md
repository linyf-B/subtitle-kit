...
> **当前约束**：每天 1～2h，主要用 Cursor；可写内容、可做白帽外链；域名第 6 月前可不买。  
...
## §3 每周时间预算（1～2h/天 ≈ 7–14h/周）

| 块 | 周时长 | 内容 |
|----|--------|------|
| **A 生产** | 8–10h | Cursor：guides / 新工具 / 改 Top queries 页 |
| **B 数据** | 30min | GSC + Cloudflare UV 记入表格 |
| **C 发布** | 30min | git push、看 Cloudflare Deploy |
| **D 外链** | 0h（S1）→ 2h（S2 起） | 目录提交 / 社区回答 / GitHub |
